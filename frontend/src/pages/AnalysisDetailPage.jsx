  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.fileInfo}>
        ...
        <p>
          <strong>Pages:</strong> {analysis.totalPages}
        </p>
        <p>
          <strong>Extraction Method:</strong> {analysis.extractedVia}
        </p>
        <p>
          <strong>Status:</strong>{" "}
          <span style={styles.badge}>{analysis.status}</span>
        </p>
      </div>
        ...
        <div style={styles.results}>
            ...
            <div style={styles.section}>
              ...
              <div style={styles.summaryCard}>
                <p>
                  ...
                  {analysis.analysis.overall_summary.verdict}
                </p>
                <p>
                  <strong>Confidence:</strong>{" "}
                  {analysis.analysis.overall_summary.confidence_level}
                </p>
                <p style={styles.summary}>
                  {analysis.analysis.overall_summary.one_line_summary}
                </p>
              </div>
            </div>
          )}
            ...
            <div style={styles.section}>
              ...
              {analysis.analysis.potential_issues.map((issue, index) => (
                <div key={index} style={styles.issueCard}>
                  ...
                  <p>
                    <strong>Why flagged:</strong> {issue.why_flagged}
                  </p>
          ...
          {analysis.analysis.insurance_attention_items?.length > 0 && (
            <div style={styles.section}>
              ...
              {analysis.analysis.insurance_attention_items.map(
                (item, index) => (
                  <div key={index} style={styles.insuranceCard}>
                    <h4>{item.item_name}</h4>
                    <p>{item.reason}</p>
                    <p>
                      <strong>Coverage likelihood:</strong>{" "}
          ...
          {analysis.analysis.final_advice_for_patient?.length > 0 && (
            <div style={styles.section}>
              ...
              <ul style={styles.adviceList}>
                {analysis.analysis.final_advice_for_patient.map(
                  (advice, index) => (
